...
export const HeroSearchForm = () => {
  ...
  return (
    <form onSubmit={handleSearch} className="flex flex-col gap-8 w-full">
      ...
      <Button className="flex items-center gap-5 border-2 w-full justify-center rounded-[10px] border-gray-800 text-gray-800 py-4 bg-yellow-500 hover:bg-orange-500 md:w-[153px] md:px-2 md:shrink-0"><span className="font-syne text-[16px]">Explore</span><BinocularIcon/></Button>
      <div className="
          w-full h-0 
           md:h-[2px]
