...
const Hero = () => {
  return (
    <section className="b-2 border-gray-600 border-dashed">
      <div className="flex flex-col min-[1200px]:flex-row items-start min-[1200px]:items-center min-[1200px]:gap-[clamp(50px,10vw,250px)] relative">
        <div className="flex flex-col items-center md:items-start relative">
          ...
          <p className="font-syne text-[14px] md:text-[16px] text-gray-800 dark:text-gray-100 leading-relaxed md:absolute md:top-51">
  ...
  "
          ...
          <div className="relative border-2 border-gray-800 rounded-tr-[20px] rounded-bl-[20px] overflow-hidden bg-white">
            <Image
              src={Library}
